...
export class DialogHelperService {
  ...
  /**
   * Product Brand specific dialogs
   */
  brand = {
    confirmDelete: (brandName: string) => {
      return this.confirmDelete(
        brandName,
        'PRODUCT_BRANDS.DIALOGS.DELETE_MESSAGE'
      );
    },
    ...
    showCreateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'PRODUCT_BRANDS.DIALOGS.SUCCESS_CREATE'
      );
    },
    ...
    showUpdateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'PRODUCT_BRANDS.DIALOGS.SUCCESS_UPDATE'
      );
    },
    ...
    showDeleteSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'PRODUCT_BRANDS.DIALOGS.SUCCESS_DELETE'
      );
    },
    ...
    showCreateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'PRODUCT_BRANDS.DIALOGS.ERROR_CREATE'
      );
    },
    ...
    showUpdateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'PRODUCT_BRANDS.DIALOGS.ERROR_UPDATE'
      );
    },
    ...
    showDeleteError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'PRODUCT_BRANDS.DIALOGS.ERROR_DELETE'
      );
    }
  };
